...
class CustomTextFormFieldC extends StatefulWidget {
  ...
  @override
  State<CustomTextFormFieldC> createState() => _CustomTextFormFieldState();
}

class _CustomTextFormFieldState extends State<CustomTextFormFieldC> {
